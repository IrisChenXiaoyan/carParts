...
<body>
	<script type="text/javascript">
		PL._init();
		PL.joinListen("/push3");//监听该主题的事件，如果发生该主题的事件，那么onData()方法会被调用
		
		
		function onData(event){
			$.messager.lays(300, 200);
			$.messager.show('<font color=red>新消息</font>', '<font color=green style="font-size:14px;font-weight:bold;">'+event.get("message")+'<br>点击<a href="house2msg.jsp">查看</a></font>',0);
		}	
	</script>
	 ...
	 <table  style="margin-left:auto;margin-right:auto;width:100%" >
 		...
 		<%
 			ArrayList<Message> list0=Message.getWarehouseMessageList(3);
 			int i=1;
 		 ...
 		 %>
 		 	<tr>
 		 		...
 		 		<td><%= fi.getMsgcont() %></td>
 		 		<td><%= fi.getMsgdate() %></td>
 		 		<td><a href="markread2.jsp?id=<%=id%>">标记为已读</a></td>
 		 	</tr>
 		 <%
 		 	i++;
 				}
 	...
 	<table   style="margin-left:auto;margin-right:auto;width:100%">
 		...
 		<%
 			ArrayList<Message> list1=Message.getWarehouseMessageList(3);
 			int j=1;
 	...
 	<br>
 	<p style="margin-left:auto;margin-right:auto;width:7em"><a href="warehouse2.jsp">返回主页面</a></p>
</body>
</html>